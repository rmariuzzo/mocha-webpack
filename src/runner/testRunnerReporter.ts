...
const formatTitleInfo = (title: string) => chalk.inverse("", title, "");
const formatTitleWarn = (title: string) => chalk.black.bgYellow("", title, "");
const formatTitleError = (title: string) =>
  chalk.white.bold.bgRed("", title, "");
...
class Reporter {
  ...
  static displayErrors(severity: string, errors: Array<any>) {
    ...
    const titleColor =
      severity === "error" ? formatTitleError : formatTitleWarn;
